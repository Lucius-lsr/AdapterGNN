...
first_legend = plt.legend(fontsize=30, loc="upper left", handles=[l2, l4], title='Test', title_fontsize=30)
ax = plt.gca().add_artist(first_legend)
plt.legend(fontsize=30, loc="upper center", bbox_to_anchor=(0.6, 1.0), handles=[l1, l3], title='Training', title_fontsize=30)
