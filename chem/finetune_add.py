...
from model_add import GNN_add, GNN_add_graphpred
...
def main(runseed):
    ...
    for target in range(len(target_list)):
        ...
        # set up model
        model = GNN_add_graphpred(args.num_layer, args.emb_dim, JK=args.JK, drop_ratio=args.dropout_ratio,
        ...
        # model_param_group.append({"params": model.gnn.feature_add})
