...
class AdapterGNN_graphpred(torch.nn.Module):
    """
    ...
    def __init__(self, args, num_layer, emb_dim, num_tasks=2, JK="last", drop_ratio=0, graph_pooling="mean", gnn_type="gin"):
        super(AdapterGNN_graphpred, self).__init__()
        self.num_layer = num_layer
        self.drop_ratio = drop_ratio
        self.JK = JK
        self.emb_dim = emb_dim
