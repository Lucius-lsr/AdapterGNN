...
class GNN_add(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK = "last", drop_ratio = 0, gnn_type = "gin"):
        ...
        self.feature_add = nn.Parameter(torch.randn(emb_dim))
...
class GNN_add_graphpred(torch.nn.Module):
    """
    ...
    def __init__(self, num_layer, emb_dim, JK = "last", drop_ratio = 0, graph_pooling = "mean", gnn_type = "gin"):
        super(GNN_add_graphpred, self).__init__()
        self.num_layer = num_layer
        self.drop_ratio = drop_ratio
        self.JK = JK
        self.emb_dim = emb_dim
        ...
        self.gnn = GNN_add(num_layer, emb_dim, JK, drop_ratio, gnn_type = gnn_type)
