...
class GNN(torch.nn.Module):
    ...
    def __init__(self, num_layer, emb_dim, JK="last", drop_ratio=0, gnn_type="gin"):
        ...
        # self.reweights = torch.nn.Parameter(torch.zeros((2, num_layer, emb_dim)))
        self.reweights = torch.nn.Parameter(torch.ones((2, num_layer, emb_dim)))
        self.register_parameter('reweights', self.reweights)
        self.scale = torch.nn.Parameter(torch.zeros(1))
        self.scale.data += 0.01
    ...
    def forward(self, *argv):
        ...
        for layer in range(self.num_layer):
            h = h_list[layer]
            h = h + self.scale * h * self.reweights[0][layer]
...
class GNN_graphpred_reweight(torch.nn.Module):
    """
    ...
    def __init__(self, num_layer, emb_dim, num_task=2, JK="last", drop_ratio=0, graph_pooling="mean", gnn_type="gin"):
        super(GNN_graphpred_reweight, self).__init__()
        self.num_layer = num_layer
        self.drop_ratio = drop_ratio
        self.JK = JK
        self.emb_dim = emb_dim
